...
class AppRoute {
  ...
  static final menuOptions = <MenuRouter>[
    ...
    MenuRouter(
        ...
        screen: CardPage()),
    MenuRouter(
        route: 'bloc', icon: Icons.accessibility, name: 'bloc', screen: Bloc()),
    MenuRouter(
        route: 'provider',
    ...
    MenuRouter(
        ...
        name: 'slider and checkbock',
        screen: SliderScreen()),
    MenuRouter(
        route: 'listviewbuilder',
        icon: Icons.list_alt_outlined,
        name: 'listview builder',
        screen: ListviewBuilder()),
    MenuRouter(

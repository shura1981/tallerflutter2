...
// });
    ...
    return Scaffold(
        appBar: AppBar(
            title: Column(
          children: [
            // Consumer<HeroresInfo>(
            //     builder: (context, _heroe, child) =>
            //         Text(_heroe.heroe + ' Vs ')),
            // Consumer<VillanosInfo>(
            //     builder: (context, _villano, child) => Text(_villano.villano)),
                Text(_heroe.heroe +' Vs '+ _villano.villano)
          ],
        )),
        body: Body(),
